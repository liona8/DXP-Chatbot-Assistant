...
import type { StudentChatContext } from "@/components/StudentChat";
...
export default function ProjectDetailPage() {
  ...
  const topbarDeadline = project?.submission_end_date
    ...
    : null;
  const studentContext: StudentChatContext | undefined = project
    ? {
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="flex flex-1 overflow-hidden relative">
          ...
          <StudentChat
            key={`${studentContext?.userId}-${studentContext?.projectId ?? "no-project"}`}
            isOpen={chatOpen}
