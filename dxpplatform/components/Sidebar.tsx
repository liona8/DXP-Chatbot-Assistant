...
import { LayoutDashboard, FolderKanban, FileText, BookOpen, Star, User, HelpCircle } from "lucide-react";
...
export default function Sidebar() {
  return (
    <aside className="w-55 min-w-55 bg-white border-r border-gray-100 flex flex-col py-4 h-screen">
      {/* Logo */}
      ...
      <div className="px-4 pt-4 border-t border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs font-medium text-gray-900">Tok Pei Ying</div>
            <div className="text-[10px] text-gray-400">tionatok09@gmail.com</div>
          </div>
        </div>
      </div>
    </aside>
